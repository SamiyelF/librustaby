...
void draw_bg(int x, int y, double pct) {
  ...
  POINT hu = {22, 17},
        hl = {53, 39}; // coords for head block (upper left, lower right)
  ...
  POINT tk = {37, 4};
  int tkrad = 4; // coords and radius for top knot circle
  POINT p1 = {36, 16}, p2 = {37, 9},
        p3 = {39, 16}; // coords of the corners of top knot post
  POINT eoL = {24, 29};
  int eoLrad = 9; // eye outline (2 circles and box)
  POINT eoR = {50, 29};
  int eoRrad = 9;                       //
  POINT eou = {31, 23}, eol = {43, 35}; //
  POINT ebL = {28, 29};
  int ebLrad = 6; // eye balls (2 circles and box)
  POINT ebR = {46, 29};
  int ebRrad = 6;                       //
  POINT ebu = {31, 27}, ebl = {43, 33}; //
  POINT pL = {32, 28};
  int pLrad = 4; // left pupil
  POINT pR = {42, 28};
  int pRrad = 4;                        // right pupil
