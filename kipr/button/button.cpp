...
IdButton *const kipr::button::all[8] = {&A, &B, &C, &X, &Y, &Z, &Left, &Right};
...
IdButton::IdButton(const Id &id, const char *defaultText) : m_id(id) {
...
bool IdButton::value() const { return Button::instance()->isPressed(m_id); }

void IdButton::resetText() { setText(m_defaultText); }
...
bool ExtraButtons::isShown() { return Button::instance()->isExtraShown(); }
